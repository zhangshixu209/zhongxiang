...
public interface IZxFriendService {
	 ...
	 * @throws NzbServiceException 自定义异常
	 */
	void queryZxFriendDetail(InputDTO input, OutputDTO output) throws NzbServiceException;
	 ...
	 * @throws NzbServiceException 自定义异常
	 */
	void checkZxFriendGroupInfo(InputDTO input, OutputDTO output) throws NzbServiceException;
