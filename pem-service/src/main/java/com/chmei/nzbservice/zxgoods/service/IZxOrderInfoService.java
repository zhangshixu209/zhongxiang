...
public interface IZxOrderInfoService {
	 ...
	 * @return
	 */
	void userConfirmReceipt(InputDTO input, OutputDTO output) throws NzbServiceException;
	 ...
	 * @return
	 */
	void queryLogisticsCompanyList(InputDTO input, OutputDTO output) throws NzbServiceException;
