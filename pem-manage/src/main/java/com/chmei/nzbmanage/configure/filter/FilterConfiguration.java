...
public class FilterConfiguration {
	...
	public FilterRegistrationBean sessionFilter() {
		...
		sessionFilter.initWhiteList("/login/login.html,/noRight.html,/api/pb/admin/.*,/api/member/.*");
	...
	public FilterRegistrationBean rightFilter() {
		...
		rightFilter.initWhiteList("/index.html,/noRight.html,/login/login.html,/api/pb/admin/.*,/assets/.*,/api/adminRight/.*,/api/member/.*");
	...
	public FilterRegistrationBean xSSFilter() {
		...
		xSSFilter.initWhiteList("/api/adminRight/btnAuthorize,/api/sys/right/addRight,/api/sys/right/editRight,/api/pb/admin/login,/api/member/.*");
