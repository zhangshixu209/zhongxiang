...
//				}
		...
		createBadge: function(e,eg) {
			var d = this;
			c("<span/>", {
				"class": "tag"
			}).text(e).append(c("<button type='button' class='close' datag='"+eg+"'>&times;</button>").on("click", function() {
				d.remove(d.element.siblings(".tag").index(c(this).closest(".tag")),c(this).attr("datag"))
